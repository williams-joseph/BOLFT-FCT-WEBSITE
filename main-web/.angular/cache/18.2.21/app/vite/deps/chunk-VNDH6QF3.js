...
async function _reloadWithoutSaving(user3) {
  ...
  const response = await _logoutIfInvalidated(user3, getAccountInfo(auth, {
    idToken: idToken3
  }));
  _assert(
...
async function updateProfile(user3, {
  displayName,
  photoURL: photoUrl
}) {
...
rxfire/auth/index.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-VNDH6QF3.js.map
